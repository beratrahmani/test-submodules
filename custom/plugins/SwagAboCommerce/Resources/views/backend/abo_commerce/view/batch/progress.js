...
// {block name="backend/abo_commerce/view/batch/Progress"}
Ext.define('Shopware.apps.AboCommerce.view.batch.Progress', {
     ...
     * @string
     */
    alias: 'widget.abo-commerce-progress',
     ...
     */
    snippets: {
        title: '{s name=progress/title}Execute orders{/s}',
    ...
    createStartButton: function() {
        ...
        return Ext.create('Ext.button.Button', {
            ...
            handler: function() {
                ...
                me.fireEvent('startProcess', me.selection);
            }
        });
    },
