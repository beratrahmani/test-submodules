...
require_once __DIR__ . '/../../../Controllers/Widgets/LiveShopping.php';

use Shopware_Controllers_Widgets_LiveShopping;

class WidgetsLiveShoppingMock extends Shopware_Controllers_Widgets_LiveShopping
{
    /**
