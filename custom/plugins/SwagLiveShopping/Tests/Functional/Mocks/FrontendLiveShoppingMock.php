...
require_once __DIR__ . '/../../../Controllers/Frontend/LiveShopping.php';

use Shopware_Controllers_Frontend_LiveShopping;

class FrontendLiveShoppingMock extends Shopware_Controllers_Frontend_LiveShopping
{
    /**
