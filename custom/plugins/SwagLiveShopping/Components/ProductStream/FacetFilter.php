...
namespace SwagLiveShopping\Components\ProductStream;
...
class FacetFilter implements FacetFilterInterface
{
    ...
    /**
     * @param FacetFilterInterface $coreFacetFilter
     */
    ...
    /**
     * Add the live-shopping-filter to the collection
     * {@inheritdoc}
     */
    public function add(Criteria $criteria)
    {
        ...
        if ($criteria->hasBaseCondition('live_shopping')) {
