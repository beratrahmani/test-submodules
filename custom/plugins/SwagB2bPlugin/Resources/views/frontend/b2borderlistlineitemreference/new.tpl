...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    <form action="{url action=create}" method="post" data-ajax-panel-trigger-reload="order-list-grid" id="form" class="form--inline {b2b_acl controller=b2borderlistlineitemreference action=create}">
        ...
        <div class="scrollable without--any with--padding">
            ...
            {include file="frontend/b2borderlistlineitemreference/_form.tpl"}
        </div>
    </form>
{/block}
