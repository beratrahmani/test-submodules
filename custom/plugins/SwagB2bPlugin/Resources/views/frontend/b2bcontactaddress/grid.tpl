...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    ...
    {if $addresses}
        ...
        {foreach $addresses as $address}
            <form action="{url action=assign}" method="post" class="b2b--assignment-form ignore--b2b-ajax-panel {b2b_acl controller=b2bcontactaddress action=assign}">
                <input type="hidden" name="contactId" value="{$contact->id}" />
                <input type="hidden" name="addressId" value="{$address->id}" />
                <input type="hidden" name="type" value="{$type}" />

                <div class="row--address row--address-selection panel--tr">
