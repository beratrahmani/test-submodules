                        ...
                        <table class="table-unstyled">
                            <tr>
                                <td class="col-checkbox">
                                    ...
                                    <form action="{url action=assign}" method="post" class="b2b--assignment-form ignore--b2b-ajax-panel {b2b_acl controller=b2bcontactrolevisibility action=assign}">
                                ...
                                <td>
                                    {if $role->hasChildren}
                                        <a href="{url parentId=$role->id contactId=$contactId}" title="{s name="Open"}Open{/s}">
                                    {/if}
