...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    ...
    {elseif !$gridState.data|count}
        {include file="frontend/_includes/messages.tpl" type="info" content="{s name="EmptyAssignmentOrderList"}There are no order lists yet. You can create them in the order list managmenet panel.{/s}"}
    {/if}
