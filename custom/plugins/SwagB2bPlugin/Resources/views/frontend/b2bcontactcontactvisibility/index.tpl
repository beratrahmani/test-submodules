...
{block name="b2b_modal_base_settings"}
    ...
    {* Disable Bottom Bar if no data exists *}
...
{block name="b2b_modal_base_content_inner_scrollable_inner_actions_inner"}
    <form method="get" class="form--inline" action="{url}">
        <input type="hidden" name="contactId" value="{$baseContact->id}">
...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    ...
    {if $contacts}
        ...
        {foreach $contacts as $contact}
            <form action="{url action=assign}" method="post" class="b2b--assignment-form ignore--b2b-ajax-panel {b2b_acl controller=b2bcontactcontactvisibility action=assign}">
                <input type="hidden" name="baseContactId" value="{$baseContact->id}" />
