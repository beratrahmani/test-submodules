...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    ...
    <form action="{url action=create}" method="post" data-ajax-panel-trigger-reload="company-tab-panel" id="form" class="form--inline {b2b_acl controller=b2baddress action=create}">
