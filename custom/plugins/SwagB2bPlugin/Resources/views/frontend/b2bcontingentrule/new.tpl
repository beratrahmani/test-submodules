...
{block name="b2b_modal_base_content_inner_scrollable_inner_content_inner"}
    ...
    <form action="{url action=create}" method="post" data-ajax-panel-trigger-reload="role-grid" id="form" class="{b2b_acl controller=b2bcontingentrule action=new}">
        ...
        <div class="b2b--ajax-panel" data-url="" data-id="contingent-rule-type-form"></div>
    </form>
{/block}
...
{block name="b2b_modal_base_content_inner_scrollable_inner_bottom_inner"}
    <div class="bottom--actions">
        <a class="btn is--left {b2b_acl controller=b2bcontingentrule action=grid}"
