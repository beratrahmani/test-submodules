...
Ext.define('Shopware.apps.b2bOffer.view.detail.decline.Detail', {
    extend: 'Ext.form.Panel',
    alias: 'widget.offer-detail-decline-detail',
        ...
        },
        {
            ...
            items: [{
                ...
                handler: function () {
                    ...
                    me.fireEvent('declineOffer', me.offer, me.parentWindow);
                },
            }],
        }
    ],
