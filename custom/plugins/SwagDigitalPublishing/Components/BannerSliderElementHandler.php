...
class BannerSliderElementHandler implements ComponentHandlerInterface
{
    const NAME = 'emotion-digital-publishing-slider';
    ...
    /**
     * @param ContentBannerInterface $contentBannerService
     */
    ...
    public function handle(ResolvedDataCollection $collection, Element $element, ShopContextInterface $context)
    {
        ...
        /** @var array $rawBanners */
        $rawBanners = json_decode($data['digital_publishing_slider_payload'], true);
        $banners = [];

        foreach ($rawBanners as $rawBanner) {
            $banners[] = $this->contentBannerService
                ->get($rawBanner['id'], $context);
        }
